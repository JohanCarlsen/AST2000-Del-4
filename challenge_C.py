...
test = v_rad_rel_home_star(star_doppler_shifts[0],star_doppler_shifts[1])   # we know that is the craft has velocity 0 in xy-system, the doppler shifts must be the same for the craft as for our home star.
# print(test)
'''
[-0. -0.]
'''
